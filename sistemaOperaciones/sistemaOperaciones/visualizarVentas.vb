...
Public Class visualizarVentas
    ...
    Private Sub visualizarVentas_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        sql = "select id,ruta,tipo,descripcion,preciounitario,cantidad,total,fecha,cliente,comision from ventas"
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        sql = "select id,ruta,tipo,descripcion,preciounitario,cantidad,total,fecha,cliente,comision from ventas where fecha between'" + DateTimePicker1.Text + "' and '" + DateTimePicker2.Text + "'"
        Call mostrarLosDatos()
    End Sub
