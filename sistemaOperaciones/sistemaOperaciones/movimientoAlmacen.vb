...
Public Class movimientoAlmacen
    ...
    Private Sub movimientoAlmacen_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        DateTimePicker1.Format = DateTimePickerFormat.Custom
        DateTimePicker1.CustomFormat = "yyyy-MM-dd"
        DateTimePicker2.Format = DateTimePickerFormat.Custom
        DateTimePicker2.CustomFormat = "yyyy-MM-dd"
        sql = "select id,concepto,descripcion,llegadas,salidas,fecha from movimientosalmacen"
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        sql = "select id,concepto,llegadas,salidas,fecha from movimientosalmacen where fecha between'" + DateTimePicker1.Text + "' and '" + DateTimePicker2.Text + "'"
        Call mostrarLosDatos()
    End Sub
